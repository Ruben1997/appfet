        ...
        <div class="container">
            ...
            <div class="panel panel-default sombra">
                <div class="panel-body">
                    ...
                    <ul>
                        <li>Sway: Aplicación utilizada para crear y compartir historias. A través de esta novedosa herramienta, el usuario podrá, de forma sencilla, crear informes y presentaciones con gran atractivo visual. Otra de sus funcionalidades más destacable es la facilidad para compartir las presentaciones, ya que dispone de la posibilidad de crear un enlace con el que cualquier usuario podra acceder a ella.</li>
                        <li>ONE NOTE: El bloc de notas de clase de Microsoft. Se encuentra disponible en sus versiones "para Educación". Con él, el profesor podrá generar un bloc de notas, con diversos apartados útiles para la vida diaria de la clase, que podrá realizar las funciones de aula virtual. Como aspectos destacables diremos que es una herramienta de uso intuitivo y sencillo tanto para el docente (no será necesario ser un experto) como para el estudiante, lo que hace muy recomendable su uso.</li>
                        <li>Office Delve: Permite realizar búsquedas de información y contenido dentro del entorno de OFFICE 365, utilizando la tecnología "OFFICE Graph".</li>
                        <li>Microsoft Teams: Esta aplicación permite a los usuarios crear un "área de trabajo" en el que poder ser más productivos y eficaces en su labor. Dentro de una misma área, lo usuarios podrán disponer de un chat instantáneo en el que debatir las decisiones a tomar, la posibilidad de uso de las diversas herramientas Office 365, así como compartir contenidos importantes en tiempo real. Otra de las funcionalidades destacadas de Teams es que permite realizar o programar reuniones, permitiendo el uso de Skype en ellas.</li>
